    ...
    const getAllNote = async () => {
        ...
        const response = await fetch(`${host}/api/notes/fetchallnotes/`, {
            ...
            headers: {
                ...
                // "authorization": localStorage.getItem('token'),//get token from localstorage

                "authorization": "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6InJhbWVAZ21haWwuY29tIiwidXNlcmlkIjoiNjE4OGM4Mjg3NDMwODk1ZGE0MjM3NTYxIiwiaWF0IjoxNjM3MzE0NzY4LCJleHAiOjE2Mzc0MDExNjh9.fyU0d53i-iZhvqeB0sQNPPpY3ctGo7ikdYrccwM-ZfU",//auth token
